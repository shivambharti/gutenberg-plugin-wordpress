...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo get_bloginfo('template_url'); ?>/css/magnific-popup.css">

    <link rel="stylesheet" href="<?php echo get_bloginfo('template_url'); ?>/css/flaticon.css">
...
<div class="wrap">
    ...
    <div class="hero-wrap">
	    <div class="home-slider owl-carousel">
	      <div class="slider-item" style="background-image:url(<?php echo get_bloginfo('template_url'); ?>/images/bg_1.jpg);">
	      ...
	      <div class="slider-item" style="background-image:url(<?php echo get_bloginfo('template_url'); ?>/images/bg_2.jpg);">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row no-gutters slider-text align-items-center justify-content-center">
		          <div class="col-md-8 ftco-animate">
	      ...
	      <div class="slider-item" style="background-image:url(<?php echo get_bloginfo('template_url'); ?>/images/bg_3.jpg);">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row no-gutters slider-text align-items-center justify-content-center">
		          <div class="col-md-8 ftco-animate">
    	...
    	<div class="container">
    		<div class="row d-flex no-gutters">
    			<div class="col-md-6 d-flex">
    				<div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-center mb-4 mb-sm-0" style="background-image:url(<?php echo get_bloginfo('template_url'); ?>/images/about.jpg);">
    				</div>
    			</div>
    		...
    		<div class="row">
    			<div class="col-lg-6">
    				<div class="img-faqs w-100">
	    				<div class="img mb-4 mb-sm-0" style="background-image:url(<?php echo get_bloginfo('template_url'); ?>/images/about-2.jpg);">
	    				</div>
	    				<div class="img img-2 mb-4 mb-sm-0" style="background-image:url(<?php echo get_bloginfo('template_url'); ?>/images/about-1.jpg);">
	    				</div>
	    			</div>
    			</div>
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 rounded" style="background-image: url('<?php echo get_bloginfo('template_url'); ?>/images/image_1.jpg');">
              </a>
              <div class="text p-4">
              	<div class="meta mb-2">
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 rounded" style="background-image: url('<?php echo get_bloginfo('template_url'); ?>/images/image_2.jpg');">
              </a>
              <div class="text p-4">
              	<div class="meta mb-2">
                  <div><a href="#">March 31, 2020</a></div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 rounded" style="background-image: url('<?php echo get_bloginfo('template_url'); ?>/images/image_3.jpg');">
              </a>
              <div class="text p-4">
              	<div class="meta mb-2">
                  <div><a href="#">March 31, 2020</a></div>
