...
<div id="ftco-loader" class="show fullscreen"><svg class="circular" width="48px" height="48px"><circle class="path-bg" cx="24" cy="24" r="22" fill="none" stroke-width="4" stroke="#eeeeee"/><circle class="path" cx="24" cy="24" r="22" fill="none" stroke-width="4" stroke-miterlimit="10" stroke="#F96D00"/></svg></div>
  ...
  <script src="<?php echo get_bloginfo('template_url');?>/js/jquery-migrate-3.0.1.min.js"></script>
  ...
  <script src="<?php echo get_bloginfo('template_url');?>/js/jquery.waypoints.min.js"></script>
  <script src="<?php echo get_bloginfo('template_url');?>/js/jquery.stellar.min.js"></script>
  <script src="<?php echo get_bloginfo('template_url');?>/js/jquery.animateNumber.min.js"></script>
  ...
  <script src="<?php echo get_bloginfo('template_url');?>/js/scrollax.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="<?php echo get_bloginfo('template_url');?>/js/google-map.js"></script>
